...
.if 0
        SWSDK_CNTR
				SWSDK_SCAL 2,0
				SWSDK_VCTR -500,-200,0
				SWSDK_SCAL 4,0

        ; writing on death star???
        ; - not very interesting
        ; - and needs to be positioned explicitly

				SWSDK_VCTR 200,0,0
				SWSDK_COLOR SWSDK_RED,255
        SWSDK_JSRL 0x2E50
				SWSDK_VCTR 200,0,0
				SWSDK_COLOR SWSDK_MAGENTA,255
        SWSDK_JSRL 0x2E78
				SWSDK_VCTR 200,0,0
				SWSDK_COLOR SWSDK_YELLOW,255
        SWSDK_JSRL 0x2E92
				SWSDK_VCTR 200,0,0
