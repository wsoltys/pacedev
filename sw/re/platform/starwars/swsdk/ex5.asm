...
wait_AVG:
        ...
        ; - this example ping-pongs between $0000 & $1800 and
...
SW_Y = 850
        ...
        ; turrets and nose
        SWSDK_JSRL SWSDK_UpperRightTurret
        SWSDK_JSRL SWSDK_LowerRightTurret
        SWSDK_JSRL SWSDK_XWingNose
        SWSDK_JSRL SWSDK_UpperLeftTurret
        SWSDK_JSRL SWSDK_LowerLeftTurret
