...
architecture SYN of custom_io is
  ...
  -- actually comes from not key(1)
  alias m6809e_oe_reset   : std_logic is platform_o.arst;
  alias m6809e_oe_d       : std_logic is io_di(21); -- (cpu_rw_n)
...
begin
  ...
  gpio_o(30) <= platform_o.cpu_6809_rst_n;  gpio_oe(30) <= '1';
